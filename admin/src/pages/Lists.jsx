  ...
  const removeList=async(id)=>{
    try {
      ...
      if(result.data){
        ...
        console.log("Field to remove Product ")
      }
    } catch (error) {
      console.log(error)
    }
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-b from-[#141414] to-[#0c2025] text-white'>
      ...
      <div className='w-[100%] h-[100%] flex items-center justify-start'>
        ...
        <div className='w-[82%] h-[200%] lg:ml-[320px] md:ml-[320px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]'>
          ...
          <div className='w-[400px] h-[50px] text-[28px] md:text-[40px] mb-[20px] text-white '>All Listed Products</div>

            {
              list?.length> 0 ?(
                list.map((item,index)=>(
                  <div className='w-[90%] md:h-[120px] h-[90px] bg-slate-600 rounded-xl flex items-center justify-start gap-[5px] md:gap-[30px] gap-[10px] md:px-[30px]'key={index}>
