          ...
          <form onSubmit={handleSignup} className='w-[90%] h-[90%]  flex flex-col itens-center justify-start gap-[20px] ' >
           ...
           <div className='w-[40%] h-[1px] bg-[#96969635]'></div>OR<div className='w-[40%] h-[1px] bg-[#96969635]'></div>
             ...
             <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative '>
              <input type='text' className='w-[100%] h-[50px] border-[2px] border-[#96969635] backdrop:blur-sm rounded-lg shadow-lg bg-transparent placeholder-[#ffffffc7] px-[20px] font-semibold outline-none'placeholder='UserName'onChange={(e)=>setName(e.target.value)} value={name} required/>
