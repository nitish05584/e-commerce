        ...
        <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center '>
          <form onSubmit={handleSignin} className='w-[90%] h-[90%]  flex flex-col itens-center justify-start gap-[20px] '>
           ...
           <div className='w-[40%] h-[1px] bg-[#96969635]'></div>OR<div className='w-[40%] h-[1px] bg-[#96969635]'></div>
            ...
            {!show && <IoEyeOutline className='w-[20] h-[20px] cursor-pointer absolute right-[5%] bottom-[57%]' onClick={()=>setShow(prev=>!prev)}/>}

                {show && <IoEyeSharp className='w-[20] h-[20px] cursor-pointer absolute right-[5%] bottom-[57%]'onClick={()=>setShow(prev=>!prev)}/>}
             ...
             <p className='flex gap-[10px]'>you have no account?<span className='text-[#5555f6cf] text-[17px] font-semibold cursor-pointer'onClick={()=>navigate("/signup")}>New Registration</span></p>
             </div>
