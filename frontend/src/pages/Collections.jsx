...
const Collections = () => {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-b from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2]'>
      
      <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] ${showFilter ? "h-[45vh]" :"h-[8vh]"} min-h-[100vh] p-[20px] border-r border-gray-400 text-[#aaf5fa] lg:fixed `}>
