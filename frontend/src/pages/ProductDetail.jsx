...
const ProductDetail = () => {
    ...
    return productData ? (
        <div>
            <div className='w-[100vw] h-[130vh] mid:h-[100vh] flex items-center justify-start flex-col bg-gradient-to-b from-[#141414] to-[#0c2025] gap-[20px] lg:flex-row'>
                ...
                <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg-py-[0px] gap-[10px] '>
                    <h1 className='text-[40px] font-semobold text-[aliceblue] '>{productData.name.toUpperCase()}</h1>
                         ...
                         <FaStar className='text-[20px] fill-[#FFD700] ' />
                          ...
                          <FaStar className='text-[20px] fill-[#FFD700] ' />
                           ...
                           <FaStar className='text-[20px] fill-[#FFD700] ' />
                            ...
                            <p className='text-[18px] font-semobold pl-[5px] text-[white] '>(124)</p>
                       </div>

                       <p className='text-[30px] font-semibold pl-[5px] text-[white] '>{currency} {productData.price}</p>

                       <p className='w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-[white]'>{productData.description} and Stylish, breathable cotton shirt with a moders slim fit. Easy to wash super comfortable, and designed for effortless style.</p>

                       <div className='flex flex-col gap-[10px] my-[10px]'>
                        <p className='text-[25px] font-semobold pl-[5px] text-[white] '> Select Size</p>
