    ...
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px] '>
        ...
        <div className='w-[100%] md:h-[30vh] md:mb-[0px] bg-[#bdfcfcec] flex items-center justify-center md:px-[50px] px-[5px] '>
            ...
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]'>
             ...
             <p className='text-[15px] text-[#1e2223] hidden md:block'>OneCart is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, ans fast delivery-all backed by trusted service designed to make your life easier every day</p>
            ...
            <div className='w-[40%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <ul>
                <li className='text-[15px] text-[#1e2223] hidden md:block cursor-pointer'>+91-9576536863</li>
                <li className='text-[15px] text-[#1e2223] cursor-pointer'>contact@fhfodrp</li>

                <li className='text-[15px] text-[#1e2223] cursor-pointer'>+1-123-456-789</li>
        ...
        <div className='w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright 2026@onecart.com-All Rights Reserved
